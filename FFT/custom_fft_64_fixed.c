        ...
        if (step < 4) { 
            ...
            for (int i = 0; i < 64; i += jump) {
                ...
                for (int j = 0; j < step; j += 4) { 
                    ...
                    float tr_arr[4] = { 
                        twiddle_real_64[(j+0)*twiddle_step], 
                        twiddle_real_64[(j+1)*twiddle_step], 
                        twiddle_real_64[(j+2)*twiddle_step], 
                        twiddle_real_64[(j+3)*twiddle_step] 
                    }; 
                    float ti_arr[4] = { 
                        twiddle_imag_64[(j+0)*twiddle_step], 
                        twiddle_imag_64[(j+1)*twiddle_step], 
                        twiddle_imag_64[(j+2)*twiddle_step], 
                        twiddle_imag_64[(j+3)*twiddle_step] 
                    }; 
