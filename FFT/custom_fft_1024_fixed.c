        ...
        if (step < 4) { 
            ...
            for (int i = 0; i < 1024; i += jump) {
                ...
                for (int j = 0; j < step; j += 4) { 
                    ...
                    float tr_arr[4] = { 
                        twiddle_real_1024[(j+0)*twiddle_step], 
                        twiddle_real_1024[(j+1)*twiddle_step], 
                        twiddle_real_1024[(j+2)*twiddle_step], 
                        twiddle_real_1024[(j+3)*twiddle_step] 
                    }; 
                    float ti_arr[4] = { 
                        twiddle_imag_1024[(j+0)*twiddle_step], 
                        twiddle_imag_1024[(j+1)*twiddle_step], 
                        twiddle_imag_1024[(j+2)*twiddle_step], 
                        twiddle_imag_1024[(j+3)*twiddle_step] 
                    }; 
