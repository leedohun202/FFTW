...
void custom_fft_64_int16_radix8(int16_t *__restrict__ r, int16_t *__restrict__ i) {
    const int N = 64;
    ...
    for (int step = 8; step <= N; step *= 8) {
        ...
        for (int j = 0; j < n8; j += 8) {
            ...
            for (int lane = 0; lane < 8; lane++) {
                ...
                c1[lane] = twiddle_int16_real_64[idx1];     s1[lane] = twiddle_int16_imag_64[idx1];
                c2[lane] = twiddle_int16_real_64[idx1 * 2]; s2[lane] = twiddle_int16_imag_64[idx1 * 2];
                c3[lane] = twiddle_int16_real_64[idx1 * 3]; s3[lane] = twiddle_int16_imag_64[idx1 * 3];
                c4[lane] = twiddle_int16_real_64[idx1 * 4]; s4[lane] = twiddle_int16_imag_64[idx1 * 4];
                c5[lane] = twiddle_int16_real_64[idx1 * 5]; s5[lane] = twiddle_int16_imag_64[idx1 * 5];
                c6[lane] = twiddle_int16_real_64[idx1 * 6]; s6[lane] = twiddle_int16_imag_64[idx1 * 6];
                c7[lane] = twiddle_int16_real_64[idx1 * 7]; s7[lane] = twiddle_int16_imag_64[idx1 * 7];
            }
