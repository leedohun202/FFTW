...
void custom_fft_256_int16_radix4(int16_t *__restrict__ real, int16_t *__restrict__ imag);
void custom_fft_512_int16_radix4(int16_t *__restrict__ real, int16_t *__restrict__ imag);
