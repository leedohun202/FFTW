...
// -----------------------------------------------------------------------------
// [포인터 마법 2] 매번 계산하던 주소 뒤섞기를 한 번에 처리할 LUT 배열 선언
// -----------------------------------------------------------------------------
...
void init_resources() {
    // [포인터 마법 2] 프로그램 시작 시 모든 크기의 뒤섞인 주소(Bit-Reversal)를 미리 계산
...
// -----------------------------------------------------------------------------
// [포인터 마법 1] __restrict__ 키워드를 선언하여 컴파일러의 족쇄 해제
// -----------------------------------------------------------------------------
void custom_fft_2048_fixed(float *__restrict__ real, float *__restrict__ imag) {
    // [포인터 마법 2 적용] while 루프 계산을 버리고 LUT에서 즉시 매핑
